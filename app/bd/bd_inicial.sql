...
CREATE TABLE `configuracion` (
  ...
  `telegram_notificacion` tinyint(1) NOT NULL,
  ...
  `telegram_conexion` tinyint(1) NOT NULL,
  `telegram_empieza_grabacion` tinyint(1) NOT NULL,
  `telegram_para_grabacion` tinyint(1) NOT NULL,
  ...
  `texto_empieza_grabacion` varchar(500) NOT NULL,
  `texto_para_grabacion` varchar(500) NOT NULL,
...
INSERT INTO `configuracion` (
								...
								`texto_tiempo`,
								`texto_conexion`,
								`texto_empieza_grabacion`,
								`texto_para_grabacion`,
								`bot_token`,
								`id_chat`,
								`unidadTiempo`,
								`ip_permitida`
								...
								'%%fecha%%: El usuario <b>%%usuario%%</b> ha empezado a grabar <b>%%canal%%</b> (%%programa%%)',
								'%%fecha%%: El usuario <b>%%usuario%%</b> ha parado de grabar <b>%%canal%%</b> (%%programa%%)',
								'token',
								'id chat',
								'Minutos',
								'192.168.1'
