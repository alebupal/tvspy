...
RUN add-apt-repository -y ppa:ondrej/php && \
  ...
  apt-get update && \
  apt-get -y upgrade && \
  apt-get -y install supervisor wget git apache2 php-xdebug libapache2-mod-php7.1 mysql-server phpphp7.1 phpphp7.1-mysql pwgen phpphp7.1apc phpphp7.1-mcrypt phpphp7.1-gd phpphp7.1-xml php7.1-mbstring php7.1-gettext zip unzip php7.1-zip curl php7.1-curl && \
