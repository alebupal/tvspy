				...
				<div class="col-xl-4 col-sm-6 mb-3">
					<div class="card text-white bg-primary o-hidden h-100">
						<div class="card-body">
							...
							<div class="mr-5">26 reproduciones totales</div>
						</div>
				...
				<div class="col-xl-4 col-sm-6 mb-3">
					<div class="card text-white bg-warning o-hidden h-100">
						<div class="card-body">
							...
							<div class="mr-5">alebupal es el usuario más activo</div>
						</div>
						<a class="card-footer text-white clearfix small z-1" href="#">
							<span class="float-left">Ver más</span>
							<span class="float-right">
				...
				<div class="col-xl-4 col-sm-6 mb-3">
					<div class="card text-white bg-success o-hidden h-100">
						<div class="card-body">
							...
							<div class="mr-5">La 1 es el canal más activo</div>
						</div>
						<a class="card-footer text-white clearfix small z-1" href="#">
							<span class="float-left">Ver más</span>
							<span class="float-right">
				...
				<div class="col-lg-12">
					...
					<div class="card mb-3">
						<div class="card-header">
							<i class="fa fa-bell-o"></i> Últimas 10 acciones</div>
